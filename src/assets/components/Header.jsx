...
const Header = () => {
  ...
  return (
    <div className="w-[716px] h-[47px] font-archivo relative top-[31px] mx-auto rounded-[12px] bg-[#2F2F2FB2]  backdrop-blur-[15px] flex items-center justify-between text-[20px] font-bold text-white">
